...
const DriverHome = ({user}) => {
  ...
  useEffect(async () => {
    ...
    return (
      ...
      <ParcelTable parcels={pendingParcels} setParcels={setPendingParcels} setNewParcels={setApprovedParcels}  status="pending"/>
      <br />
      <Divider />

      <Header>Approved Parcels</Header>
      <ParcelTable parcels={approvedParcels} setParcels={setApprovedParcels} setNewParcels={setInTransitParcels} status="assigned"/>
